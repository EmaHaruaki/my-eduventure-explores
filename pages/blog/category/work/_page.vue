    ...
    <div class="one-container">
        <div class="gb-container gb-container-64102255">
            <div class="gb-inside-container">
                ...
                <h1 class="gb-headline gb-headline-cd476a60 gb-headline-text">Work</h1>


                <div class="gb-container gb-container-f9c8979a">
                    <div class="gb-inside-container">
                        <div class="dynamic-term-description">
                            <p>マレーシアの求人市場や就職事情、日本人がマレーシアで働くためのアドバイス、ビジネスマナーなどについて情報を提供します。</p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="gb-container gb-container-ef19b6ac">
                            <div class="gb-inside-container">
                                <div class="gb-button-wrapper gb-button-wrapper-4178d196">
                                    ...
                                    :to="`/blog/category/work/${response.pageInfo.pageNo - 1}`"><span class="gb-icon"><svg
                                    ...
                                    :to="`/blog/category/work/${response.pageInfo.pageNo + 1}`"><span
