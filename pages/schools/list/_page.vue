    ...
    <div class="one-container">
        <div class="gb-container gb-container-64102255">
            <div class="gb-inside-container">
                ...
                <h1 class="gb-headline gb-headline-cd476a60 gb-headline-text">インターナショナルスクール</h1>


                <div class="gb-container gb-container-f9c8979a">
                    <div class="gb-inside-container">
                        <div class="dynamic-term-description">
                            <p>マレーシアにあるインターナショナルスクールの情報や比較、授業料に関する情報を提供します。</p>
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="gb-inside-container">
                                                <div class="gb-button-wrapper gb-button-wrapper-135f96db">
                                                    <nuxt-link
                                                        ...
                                                        :to="`/schools/list/`">{{ n.contents_type_nm }}</nuxt-link>
                                                </div>
                                            </div>
                                        </div>

                                        <figure class="gb-block-image gb-block-image-40dc14bb"><nuxt-link
                                                :to="`/schools/details/${n.topics_id}`"><img width="1400" height="933"
                                                    :src="`${n.ext_1.url}?width=1400&height=933`" class="gb-image-40dc14bb"
